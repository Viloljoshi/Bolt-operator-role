...
function tickBlob() {
  ...
  cursorBlob.style.background = `conic-gradient(from ${hue}deg, rgba(210,63,12,0.45), rgba(255,106,44,0.4), rgba(31,170,89,0.4), rgba(13,106,106,0.35), rgba(210,63,12,0.45))`;
...
/* Hero inventory rotator, framed around Rides operations */
(function () {
  ...
  const phrases = [
    ...
    "what breaks at 2am in a new market.",
    "the agent that closes the ticket.",
    "the metric leadership can't see yet.",
    "the 80% that ships this month.",
    "the guardrail before the autonomy."
  ];
  let i = 0;
  el.textContent = "";
